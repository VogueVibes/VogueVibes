...
if ($result->num_rows === 0) {
    echo "User not found."; // Display message if user not found
    exit();
}
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($stmt->affected_rows > 0) {
        echo "Profile updated successfully."; // Display success message
    } else {
        echo "No changes made."; // Display no changes message
    }
}
?>
...
<body>
    <div class="profile-container">
        ...
        <div class="profile-actions">
            <a href="profile.php">Back to Profile</a> <!-- Link to go back to profile page -->
        </div>
    </div>
</body>
</html>
